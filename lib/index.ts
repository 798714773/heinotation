...
var script$1 = defineComponent({
  ...
  setup(__props) {
    const asd = ref(123);
    return (_ctx, _cache) => {
      return openBlock(), createBlock("div", null, toDisplayString(asd.value), 1);
    };
  }
});

script$1.__file = "src/lib/svg/Svg.vue";
...
script.__file = "src/lib/note/Note.vue";

export { script as Note, script$1 as Svg };
